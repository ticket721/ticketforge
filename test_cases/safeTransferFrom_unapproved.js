...
module.exports = {
    safeTransferFrom_unapproved: async function safeTransferFrom_unapproved(accounts, expect) {
        ...
        await expect(TicketForge.methods['safeTransferFrom(address,address,uint256)'](accounts[0], accounts[1], ticketId, {from: accounts[2]})).to.eventually.be.rejectedWith('ERC721: transfer caller is not owner, approved or scope admin');
