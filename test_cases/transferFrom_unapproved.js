...
module.exports = {
    transferFrom_unapproved: async function transferFrom_unapproved(accounts, expect) {
        ...
        await expect(TicketForge.transferFrom(accounts[0], accounts[1], ticketId, {from: accounts[2]})).to.eventually.be.rejectedWith('ERC721: transfer caller is not owner, approved or scope admin');
