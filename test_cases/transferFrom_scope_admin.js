...
module.exports = {
    transferFrom_scope_admin: async function transferFrom_scope_admin(accounts, expect) {
        ...
        await TicketForge.transferFrom(accounts[0], accounts[1], ticketId, {from: accounts[2]});
