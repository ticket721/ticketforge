...
module.exports = {
    safeTransferFrom_scope_admin: async function safeTransferFrom_scope_admin(accounts, expect) {
        ...
        await TicketForge.methods['safeTransferFrom(address,address,uint256)'](accounts[0], accounts[1], ticketId, {from: accounts[2]});
